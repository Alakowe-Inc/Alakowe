...
import { BookOpen, Bell, Package, Banknote, CheckCircle, ArrowRight } from 'lucide-react'
...
const steps = [
  ...
  },
  {
    ...
    desc: 'Bring your book to the nearest Alakowe collection centre, or request a pickup for a small convenience fee.',
  },
  {
    icon: Banknote,
    title: 'Get paid',
        ...
        <div className="max-w-8xl mx-auto px-4 md:px-6 lg:px-12 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <p className="text-white/60 text-base md:text-lg leading-relaxed mb-10 max-w-xl">
              ...
              No fees to start — we only earn when you do.
            </p>
        ...
        <div className="max-w-8xl mx-auto px-4 md:px-6 lg:px-12 py-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-main/55 text-base leading-relaxed mb-10">
              Listing is always free. Alakowe takes a <span className="font-semibold text-main">10% platform fee</span> only
